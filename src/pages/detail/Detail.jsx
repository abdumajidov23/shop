...
const Detail = () => {
  ...
  return (
    <div className="container mx-auto my-10 p-6 bg-green-50 shadow-lg rounded-lg">
      {data ? (
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          {/* Product Details */}
          <div className="w-full md:w-1/2 flex flex-col gap-6 bg-gray-50 p-6 rounded-lg shadow-md">
